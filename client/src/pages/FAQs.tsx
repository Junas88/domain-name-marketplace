...
const faqs = [
  ...
  },
  {
    ...
    answer: "Yes! We welcome domain sellers with quality names. To list your domain with us, visit our <a href='/selling-strategy' class='text-blue-600 hover:underline'>Selling Strategy</a> page or contact our team at <a href='mailto:sales@takemyname.com' class='text-blue-600 hover:underline'>sales@takemyname.com</a>. We'll help you determine a competitive price and list your domain on our marketplace."
  },
  {
    question: "What makes a domain name valuable?",
    answer: "Several factors influence a domain's value: length (shorter is typically better), memorability, keyword relevance, extension (.com domains are generally most valuable), brandability, and industry relevance. Visit our <a href='/domain-valuation' class='text-blue-600 hover:underline'>Domain Valuation</a> page to learn more about what makes domains valuable."
  },
  {
