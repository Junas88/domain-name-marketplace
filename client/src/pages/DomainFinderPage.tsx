    ...
    <Layout>
      <div className="min-h-screen">
        ...
        <section className="py-12 bg-neutral-50 border-y border-black">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto">
              <h2 className="text-3xl font-black mb-12 text-center">Our Domain Name Finder Services</h2>
        ...
        <section className="py-16 bg-white border-t border-black">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto">
              <h2 className="text-3xl font-black mb-10 text-center">What Our Clients Say</h2>
