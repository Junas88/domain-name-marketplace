...
export default function Guide() {
  return (
    <Layout>
      ...
      <section className="py-16 bg-white text-black border-t border-black">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative mx-auto lg:mx-0 max-w-md">                
                <div className="absolute -top-4 right-0 bg-black text-white py-2 px-6 font-bold rounded z-10">
                  LIMITED TIME OFFER
                </div>
                ...
                <div className="bg-white border-2 border-black p-8 rounded-lg shadow-lg">
                  ...
                  <div className="bg-black text-white p-3 rounded text-center font-bold">
              ...
              <div className="space-y-8">
                <div className="space-y-5">
                  <div className="flex items-center gap-3">
                    <div className="bg-black rounded-full p-1 w-7 h-7 flex items-center justify-center flex-shrink-0">
                  ...
                  <div className="border border-gray-300 p-5 rounded-lg bg-gray-50">
                    ...
                    <div className="mt-4 flex items-center">
                      ...
                      <div className="ml-3">
                        ...
                        <p className="text-sm text-gray-600">Domain Investor, New York</p>
                      </div>
                    </div>
                  </div>
                  
                  <div className="bg-gray-100 p-6 rounded-lg border border-gray-300 space-y-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-end gap-2">
                        <span className="text-4xl font-bold">$29.99</span>
                        <span className="text-gray-500 line-through">$99.99</span>
                      </div>
                      <span className="bg-black text-white text-sm font-bold px-3 py-1 rounded">70% OFF</span>
                    </div>
                    
                    <button className="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-4 px-6 rounded transition-colors text-xl">
                      GET INSTANT ACCESS
                    </button>
