        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-3xl font-bold mb-4">The Complete Domain Investment Guide</h2>
                <p className="text-lg text-neutral-600 mb-6">
                  Get our comprehensive ebook with expert strategies for domain investing, buying,
                  selling, and valuation techniques used by the pros.
                </p>
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium">Advanced Domain Valuation Methods</p>
                      <p className="text-sm text-neutral-500">Learn how to accurately determine a domain's true market value</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="h-6 w-6 rounded-full bg-green-100 flex items-center justify-center mt-1">
                    ...
                    <div>
                      <p className="font-medium">Portfolio Building Strategies</p>
                      <p className="text-sm text-neutral-500">Create a diversified domain portfolio that minimizes risk</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="h-6 w-6 rounded-full bg-green-100 flex items-center justify-center mt-1">
                    ...
                    <div>
                      <p className="font-medium">Negotiation Tactics That Work</p>
                      <p className="text-sm text-neutral-500">Close deals at better prices with proven negotiation strategies</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mb-6">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-sm font-medium">4.9/5 from 230+ buyers</span>
                  </div>
                  <div className="text-sm text-neutral-600 italic">
                    "This guide helped me triple my domain investment returns within a year. The valuation techniques alone are worth 10x the price." — James T.
                  </div>
                </div>
              ...
              <div className="relative">
                <div className="bg-white p-8 rounded-lg shadow-lg border border-neutral-200 transform rotate-1">
                  <div className="transform -rotate-1">
                    <div className="bg-black text-white p-6 rounded-md mb-4">
                      <h3 className="text-xl font-bold mb-2">The Complete Guide to</h3>
                      <h2 className="text-3xl font-bold mb-4">DOMAIN INVESTING</h2>
                      <p className="text-sm opacity-80">By TakeMyName.com Experts</p>
                    </div>
                    <div className="space-y-2">
                      <div className="flex gap-2">
                        <div className="w-4 h-4 rounded-full bg-black flex-shrink-0 mt-1"></div>
                        <p className="text-sm">200+ pages of expert advice</p>
                      </div>
                      <div className="flex gap-2">
                        <div className="w-4 h-4 rounded-full bg-black flex-shrink-0 mt-1"></div>
                        <p className="text-sm">25 case studies of successful domain flips</p>
                      </div>
                      <div className="flex gap-2">
                        <div className="w-4 h-4 rounded-full bg-black flex-shrink-0 mt-1"></div>
                        <p className="text-sm">Actionable valuation worksheets</p>
                      </div>
                      <div className="flex gap-2">
                        <div className="w-4 h-4 rounded-full bg-black flex-shrink-0 mt-1"></div>
                        <p className="text-sm">2025 market trend analysis</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="absolute -top-4 -right-4 bg-green-600 text-white text-sm font-bold py-2 px-4 rounded-full transform rotate-12">
                  BEST SELLER!
                </div>
              </div>
            </div>
